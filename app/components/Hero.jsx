...
import medicallogo from "../../public/MinHero1.jpg";
    ...
    <section className="p-10 py-20 md:py-24 text-center">
      <div className="container mx-auto flex flex-col lg:flex-row items-center">
        <div className="lg:w-1/2">
          <Image
            src={logo2}
            className="w-52 h-32 md:w-80 md:h-52 ml-10 md:ml-28"
            alt="Logo"
          />
          <p className="mt-4 md:mt-2 text-lg">
            We provide the best & affordable health care. Our goal is to deliver
            the highest quality healthcare services. We believe that everyone
            deserves access to excellent medical care without compromising on
            quality.
          </p>
